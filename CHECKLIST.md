...
**10.1 Built-in opponent** — ships permanently, zero configuration, and proved the turn
loop before any model was involved.
- [x] Implementation
- [x] Backend testing — returns a legal move at every difficulty over many runs;
  prefers the capture on hard; accepts plain strings as well as objects.
- [x] Frontend testing — ten plies played in the browser including castling and a capture.
